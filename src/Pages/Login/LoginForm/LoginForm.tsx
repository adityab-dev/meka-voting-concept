...
import { loginPath, personalInfoPath, registerPath } from "../../../constants/Paths";
...
export default function LoginForm() {
  const { inputValues, inputChangeHandler, formSubmitHandler, docsData } =
    useContext(login_context);

  const { Email } = docsData;
